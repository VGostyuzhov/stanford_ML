...
delta_2 = (delta_3 * Theta2) .* [ones(m, 1) sigmoidGradient(z2)]; % 5000x26
%delta_2 = delta2(:, 2:end); 

% size(a2) = 5000x26; size(delta_3) = 5000x10
Theta2_grad = (1/m) * delta_3' * a2; % 10x26
Theta1_grad = (1/m) * delta_2(:, 2:end)' * a1; % 25x401
